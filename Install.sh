...
source <(wget -qO- https://raw.githubusercontent.com/ihanr/Seedbox/main/seedbox_installation.sh)
...
while getopts "u:p:c:q:l:rbvxyz3oh" opt; do
  case ${opt} in
	...
	h ) # process option help
		...
		source <(wget -qO- https://raw.githubusercontent.com/ihanr/Seedbox/main/Torrent%20Clients/qBittorrent/qBittorrent_install.sh)
		seperator
		info "Options:"
